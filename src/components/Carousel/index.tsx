...
interface PhotoCarouselProps {
    ...
    autoPlay?: boolean
    interval?: number          // ms entre slides (si autoPlay=true)
    showIndicators?: boolean   // puntitos
    showArrows?: boolean       // flechas
    loop?: boolean             // si vuelve del último al primero
...
const PhotoCarousel = ({
    ...
    // Evitar interval si no hay suficientes imágenes
